...
* Team Populism publish datasets related to political speech ([commissioned by The Guardian](https://www.theguardian.com/world/2019/mar/06/how-we-combed-leaders-speeches-to-gauge-populist-rise)) at https://populism.byu.edu/data
* The [Industry Documents Library](https://www.industrydocuments.ucsf.edu/home/) "is a digital archive of documents which have been publicly released from industries that influence public health. It include documents publicly disclosed from the opioid, drug, chemical, food, and fossil fuel industries"
